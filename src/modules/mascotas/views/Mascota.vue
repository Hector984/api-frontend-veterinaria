        ...
        <div class="col-12">
            <TabView>
                <TabPanel>
                    ...
                    <div class="p-4">
                        <div v-if="cliente" class="p-fluid formgrid grid">
                            ...
                            <div class="field col-12 md:col-6">
                                <label for="direccionCliente" class="font-semibold">Dirección</label>
                                <InputText id="direccionCliente" v-model="cliente.direccion" />
                            </div>
                        </div>
                    </div>
                </TabPanel>
                        ...
                        <Timeline :value="historialMedico" align="alternate" class="customized-timeline">
                            ...
                            <template #content="slotProps">
                                <Card>
                                    ...
                                    <template #subtitle>{{ slotProps.item.fecha }} - {{ slotProps.item.doctor }}</template>
                                    <template #content>
