                ...
                <StepList class="w-full flex justify-between items-center mb-4">
                    <Step v-slot="{ activateCallback, value, a11yAttrs }" asChild :value="1">
                        <div class="flex flex-auto items-center" v-bind="a11yAttrs.root">
                            <button class="bg-transparent border-0 cursor-pointer p-0" @click="activateCallback" v-bind="a11yAttrs.header">
                                <span
                                    :class="[
                            ...
                            <div class="flex-auto border-t-2 ml-4 mr-2 transition-colors duration-300" :class="{ 'border-primary': activeStep > 1, 'border-surface-200 dark:border-surface-700': activeStep <= 1 }"></div>
                        </div>
                    </Step>
